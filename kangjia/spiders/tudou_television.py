...
# -*- coding: utf-8 -*-
"""
@Time: 2017/7/15 上午10:05
@Author: CZC
@File: tudou_television.py
"""
import sys
import time
...
class TudouTelevisionSpider(CrawlSpider):
    name = 'tudou_television'
    allowed_domains = ['tudou.com', 'v.youku.com', 'list.youku.com']
    start_urls = ['http://cartoon.tudou.com/category/c_85.html']

    rules = (
        Rule(LinkExtractor(allow=("/category/c_85_p_\d+\.html",)), callback='parse_item', follow=True),
        # Rule(LinkExtractor(allow=("/category/c_85.html",)), callback='parse_item'),
    ...
    def parse_detail(self, response):
        ...
        # items.add_xpath("presenter", "//div[@class='p-base']/ul/li[@class='p-row']/a/text()")
        ...
        items.add_xpath("producer", u"//div[@class='p-base']//*[contains(text(), '播出')]/child::*/text()")
